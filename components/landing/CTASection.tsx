    ...
    <section className="bg-indigo-600">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="bg-indigo-700 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
          ...
          <div className="relative -mt-6 aspect-[4/3] md:aspect-[16/9] lg:aspect-[3/2] lg:mt-0">
            <div className="absolute inset-0 transform sm:skew-y-0 lg:-skew-y-6 lg:origin-top-right">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-indigo-800 mix-blend-multiply" />
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-600 via-indigo-700 opacity-90" />
